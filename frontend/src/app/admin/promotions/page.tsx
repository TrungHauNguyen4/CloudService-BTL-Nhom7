...
import { Plus, Trash2, Loader2, Tag, Calendar, Percent } from "lucide-react";
...
export default function PromotionsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.response?.data?.message || "Tạo mới thất bại!");
    } finally {
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-background rounded-xl p-6 w-full max-w-md shadow-2xl relative border border-border">
            <h3 className="text-xl font-bold mb-4">Tạo Mã Khuyến Mãi Mới</h3>
